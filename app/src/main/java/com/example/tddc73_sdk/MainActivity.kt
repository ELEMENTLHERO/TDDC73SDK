    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            Column( modifier = Modifier
                ...
                accountReg.AddField("Address",FieldType.AddressTextField,
                    Modifier
                        .fillMaxWidth()
                        .size(100.dp),required =false)
                ...
                accountReg.AddCustomPassword("Strong password",DisplayType.Custom,reqs)
                accountReg.AddSubmitButton({ handelData(formData) })

                //Stand alone
                //val p = PasswordField(reqs)
